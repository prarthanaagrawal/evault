...
let web3 = new Web3(new Web3.providers.HttpProvider("HTTP://127.0.0.1:3000"));
const fs = require('fs');

const sourceCode = fs.readFileSync('C:\\Users\\dell\\OneDrive\\Desktop\\MediCare\\MediVault\\backend\\contracts\\Cruds.sol').toString();
